...
\begin{minipage}[c]{0.76\textwidth}
  ...
  \begin{tabular}{@{}>{\bfseries}r@{\hspace{0.35em}}l@{\hspace{2.6em}}>{\bfseries}r@{\hspace{0.35em}}l@{}}
    出生年月：& 2004年1月 & 政治面貌：& 共青团员 \\
    联系电话：& 13800000000 & 电子邮箱：& xiaoming@example.com \\
    微信：& xiaoming-demo & GitHub：& \href{https://github.com/example}{example}
  \end{tabular}}
\end{minipage}
\hfill
